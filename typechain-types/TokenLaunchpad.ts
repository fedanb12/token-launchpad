...
export interface TokenLaunchpadInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "K"
      | "balanceOf"
...
export interface TokenLaunchpad extends BaseContract {
  connect(runner?: ContractRunner | null): TokenLaunchpad;
  waitForDeployment(): Promise<this>;

  interface: TokenLaunchpadInterface;
