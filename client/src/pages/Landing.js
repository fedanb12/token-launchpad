...
export default function Landing() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: COLORS.bg, color: COLORS.text, fontFamily: "IBM Plex Mono, monospace" }}>
      ...
      {/* Stats Bar */}
      <div style={{ borderTop: `1px solid ${COLORS.border}`, borderBottom: `1px solid ${COLORS.border}`, padding: "24px 32px", display: "flex", justifyContent: "center", gap: 80, background: COLORS.surface }}>
        {[
